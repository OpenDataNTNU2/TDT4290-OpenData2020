...
export default function CreateDataset(props) {
  ...
  const [wantToRequestCoordination, setWantToRequestCoordination] = useState(
    "1"
  );
  ...
  return (
    ...
    >
      ...
      {published === "1" && accessLevel === "1" ? (
        <FormControl component="fieldset" style={{ minWidth: "50vh" }}>
          <FormLabel component="legend">
            Forespørsel om å bli med i samordning
          </FormLabel>
          <RadioInput
            id="joinCoordination"
      ...
      {wantToRequestCoordination === "2" &&
      published === "1" &&
      accessLevel === "1" ? (
        <FormControl variant="outlined" style={{ width: "50vh" }}>
          <InputLabel id="requestToJoinCoordinationLabel">
            Velg samordning
          </InputLabel>
          <Select
          ...
          >
            {coordinations.items &&
              Object.values(coordinations.items).map((coordination) =>
                coordination.publisher.id !==
                parseInt(props.prevPublisherId) ? (
