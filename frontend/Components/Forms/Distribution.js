        ...
        <div style={{ padding: '3vh' }}>
            <div>
                <form
                    noValidate
                    autoComplete="off"
                    style={{ width: '30vh', display: 'inline-block', marginRight: '1vh' }}
                >
                    <TextField
                        ...
                        onChange={(e) =>
                            handleChange(props.title, props.setTitle, props.number, e, props.title[props.number])
                        }
                    />
                </form>
