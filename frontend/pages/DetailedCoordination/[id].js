...
export default function DetailedCoordination({ data, prevPublisherId }) {
        ...
        <Grid container direction="column" style={{ minHeight: '70vh', minWidth: '90vh', padding: '5% 10% 5% 10%' }}>
            ...
            parseInt(prevPublisherId) === data.publisher.id ? null : (
                <Grid style={{ padding: '3% 0 3% 0' }}>
                    ...
                    <p>
                        Velg hvilket datasett dere vil ha med i denne samordningen og skriv en liten begrunnelse av
                        hvorfor dere ønsker å være med.
                    </p>
                    <br />
                    <Input
            ...
            <Divider variant="fullWidth" style={{ border: '1px solid grey' }} />
            <br />
