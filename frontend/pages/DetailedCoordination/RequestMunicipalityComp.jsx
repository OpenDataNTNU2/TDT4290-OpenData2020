...
const RequestMunicipalityComp = (props) => {
  ...
  return (
    <div style={{ margin: '25px 0' }}>
      ...
      <p>Foreslå til en kommune å bli med i samordningen.</p>
      {missingPublishers.length !== 0 ? (
        <FormControl variant="outlined" style={{ width: '50vh' }}>
          ...
          >
            {Object.values(missingPublishers).map((publisher) => (
      ...
      <Button variant="contained" color="primary" disabled={false} onClick={sendRequest}>
        Send forslag
      </Button>
    </div>
  );
